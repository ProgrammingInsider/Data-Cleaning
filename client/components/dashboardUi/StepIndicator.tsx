  ...
  return (
    <header className="flex flex-col gap-2 items-center w-full sticky top-0 sectionBg p-6 z-30">
        ...
        <div className="flex flex-col gap-1 justify-center items-center">
            <h1 className="primaryBg p-1 text-base font-bold w-6 h-6 rounded-full flex justify-center items-center -mr-1 z-10 hover:underline">1</h1>
        </div>
        <div className={`w-full h-2 rounded-full ${step === 2 ? "primaryBg" :"secondaryBg"}`}></div>
        <div className="flex flex-col gap-1 justify-center items-center">
            <h1 className={`p-1 text-base font-bold w-6 h-6 rounded-full flex justify-center items-center -ml-1 z-10 hover:underline ${step === 2 ? "primaryBg" :"secondaryBg"}`}>2</h1>
        </div>
        </div>
