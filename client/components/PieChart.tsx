...
const COLORS = ["#FF5733", "#FFC300", "#36A2EB", "#4CAF50", "#9C27B0", "#FF9800"];

function PieChartComponent({ issueTypeCounts }: { issueTypeCounts: IssueCountType[] }) {
  // Map data correctly for recharts
  const IssueDistribution = issueTypeCounts.map((issue, index) => ({
    name: issue.issueType, // Display name
    value: issue.totalCount, // Data count
